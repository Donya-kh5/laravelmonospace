            ...
            <div style="align-items: flex-start;display: flex;justify-content: space-between;padding: 180px 0 200px" class="wraper">
               <!-------------- start left dev------------->
                <div style="flex: 0 0 570px; margin-left: 50px; " class="content">
                    <h1 style="color:#252E48; font-size: 32px; font-weight: 700; " class="anmation rf-h1">All the tools
                    ...
                    <p>Free time-saving growth marketing tools to succeed: high quality videos, animations,
                        mockups, logos, presentations, SMM graphics, and a
                    </p>
                    <!--------end of content--------->
                    <!---->
                    <!---->
                    ...
                    <div style="display: none;position: fixed;bottom: 0;left: 15px;border: 3px solid #f1f1f1;z-index: 9;
                        ...
                        <form style="max-width: 300px;padding: 10px;background-color: white;" class="form-container">
                            ...
                            <button style="color: white;padding: 16px 20px;border: none;cursor: pointer;width: 100%;margin-bottom: 10px;
                                    opacity: 0.8;" type="submit" class=" bg-primary btn">Send</button>
...
<div style="background-color:rgb(240, 241, 243)">
    <div style="display: flex; justify-content: center; transform: translateY(-120px); ">
        <fieldset class="line"
            ...
            <legend style="justify-content: center;display: flex; text-align: center; padding-left: 8px; padding-right: 8px;
                    ...
                    line-height: 1.3;">
                  Trusted by <b style="padding: 0px 4px;">11k+</b> users and
                  <b style="padding: 0px 4px;">100+</b> high-end companies
            </legend>
        </fieldset>
    </div>
    ...
    <div style=" width: 100%; height: auto; display: flex ;justify-content: center;">
      <h2 style="font-weight: 700; margin-top: 50px;padding: 8px;"
        class=" content__badges_title rf-h3 appear-item appear-2 appear">Get work done in different categories</h2>
    </div>
    <!-------------------------->
      ...
      <div class="row ">
        ...
        <div style="margin-top: 40px; margin-left: 80px;" class="no col-4 ">
          ...
          <span style=" position: absolute; margin-left: 15px; text-align: left;cursor: pointer;" type="button">
            <h5 style="font: size 1.25rem; font-weight: 600;">Design, Media & Architecture
            </h5>
            <span style="font-size: 15px;font-family: 'RobotoSubset', 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;
  ...
  <div style="display: flex; justify-content: center; margin-top: 20px;" class="div">
    <div style="margin-top: 140px;" class="content__badges_container">
      <div class="text-center">
        ...
        <div style="padding: 20px;" class="container">
          <div style="display: flex;justify-content: center;" class="row">
            <div
              ...
              <span style="font-size: 18px; font-weight: 500;color: #545f7e; ">“Pretty Damn Surprised Right Now”</span><br>
              <div style="margin-top: 10px; margin-bottom: 10px;">
                ...
                <span style="font-size: 13px;  color: #545f7e;">
                  I have never, ever had a rep at a content mill or a MonoSpace platform come up to me and offer me a discount on their membership! And I'm not talking those automated messages that get crammed out to everyone! No, I had a wonderful rep come to me for a chat. She laid out all…
                </span>
              </div>
            </div>
            <!--1st comment-->
            ...
            <div
              style=' margin-top: 70px;background-color: #f0f1f3; padding:20px; border-radius: 5px; margin-bottom: 10px;'
              class="col-sm-12 col-lg-3 col-md-6 mx-2">
              <span style="font-size: 18px; font-weight: 600;color: #545f7e; ">I“5 Star Support”</span><br>
              <div style="margin-top: 10px; margin-bottom: 10px;">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="121.031"
                  height="19.665" viewBox="0 0 121.031 19.665">
                  <defs>
                ...
                <span style="font-size: 13px;  color: #545f7e;">
                  Active and Helpful support team. Finding Freelancer here is the fastest among top freelance network. Upgraded my project for recruitment and the MonoSpace.com staff got me the best development agency.
                </span>
              </div>
            </div>
            <!--2nd comment-->
            ...
            <div
              style=" margin-top: 70px;background-color: #f0f1f3; padding:20px; border-radius: 5px; margin-bottom: 10px;"
              class=" col-sm-12 col-lg-3 col-md-6 mx-2">
              <span style="font-size: 18px; font-weight: 600;color: #545f7e; ">“GOOD CUSTOMER SERVICE”</span><br>
              <div style="margin-top: 10px; margin-bottom: 10px;">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="121.031"
                  height="19.665" viewBox="0 0 121.031 19.665">
                  <defs>
                ...
                <span style="font-size: 13px;  color: #545f7e;">
                  I am so glad MonoSpace team help me in my case. I'm satisfied with the fastest job, the officer itself, and everything is perfect. If anyone have problem, don't hesitate to contact customer ser
                </span>
              </div>
            </div>
          </div>
        ...
        <div id="container_blogs" style="margin-top: 140px;" class="content__badges_container">
          <div class="text-center">
            <div class="content__badges_title-wrapper">
              <h3 style="font-weight: 700;" class="content__badges_title rf-h3 appear-item appear-2 appear">
                Join MonoSpce to save time and succeed!
              </h3>
              <!---------------------------------------------->
              <!----------------------------------------------->
              <!---->
                ...
                ;" class=" btn btn-outline-primary" onclick="go()">
                    ...
                    <div style="justify-content: center;">
                      ...
                      <!--
                        ...
                        -->
                      <br>
                      <div style="width: 300px; margin-bottom: 10px;" id="signin_with_github_buyer"
                        class="btn btn-dark text-light">signup with github
                      ...
                      <!--
                        ...
                        -->
                      <div style="width: 300px;margin-bottom: 10px;" id="signin_with_google_buyer"
                        class="btn btn-danger">signup with google
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            padding: 20px;position: absolute;top: 50%;transform: translate(-50%, -50%);width: 500px;z-index: 10;background-color: #FFF;">
                  ...
                  <div style=" margin-top: 200px; display: flex ; justify-content: center;">
                    <h1 style="color: #252E48;">Join as...</h1>
                  </div>
                  <!---------------------------------------------->
                  <!---------------------------------------------->
                  <div style="display: flex ; justify-content: center;margin: top 0px;">
                    <div class="btn btn-outline-success anmi" id="nw">Join as a Service Provider
                    </div>
                  </div>
                  <!---------------------------------------------->
                  <!---------------------------------------------->
                  <div style="display: flex ; justify-content: center; margin-top: 30px;">
                    <div id="new" class="btn btn-outline-success anmia">Join as a Buyer
                    </div>
                  </div>
                </div>
                <!---------------------------------------------->
      ...
      " class=" text-light getStartedBtn toggleBtn" id="willHiden">Get started</button>
              <!---------------------------------------------->
